namespace Sprint2PizzaProject
{
    partial class ShoppingCart
    {
        ...
        private void InitializeComponent()
        {
            ...
            Controls.Add(price7Label);
            Controls.Add(price6Label);
            Controls.Add(price5Label);
            Controls.Add(price4Label);
            Controls.Add(price3Label);
            Controls.Add(price2Label);
            Controls.Add(price1Label);
            Controls.Add(item10Label);
            Controls.Add(item9Label);
            Controls.Add(item8Label);
            Controls.Add(item7Label);
            Controls.Add(item6Label);
            Controls.Add(item5Label);
            Controls.Add(item4Label);
            Controls.Add(item3Label);
            Controls.Add(item2Label);
            Controls.Add(item1Label);
            Controls.Add(CheckoutButton);
            Controls.Add(keepShoppingButton);
        ...
        private Label item6Label;
        private Label item7Label;
        private Label item8Label;
        private Label item9Label;
        private Label item10Label;
